...
public class Registry
{
	...
	public static Block registerBlock(final Block block)
	{
		if (NotNull.checkNotNull(block))
		{
			...
			block.setUnlocalizedName(NameHelper.getName(block));
			...
			if (!(block instanceof BlockSlab))
			{
				...
				item.setUnlocalizedName(NameHelper.getName(block));
				item.setRegistryName(NameHelper.getModID(block), NameHelper.getName(block));
	...
	public static ItemBlock registerBlock(final ItemBlock itemBlock)
	{
		if (NotNull.checkNotNull(itemBlock))
		{
			...
			itemBlock.setUnlocalizedName("item_" + NameHelper.getName(itemBlock));
			itemBlock.getBlock().setUnlocalizedName(NameHelper.getName(itemBlock));
	...
	public static Enchantment registerEnchantment(final Enchantment chant)
	{
	...
	public static void registerTileEntity(final Block b, final Class te)
	{
		registerBlock(b);
