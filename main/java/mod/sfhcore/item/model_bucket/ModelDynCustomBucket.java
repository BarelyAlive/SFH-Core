...
public class ModelDynCustomBucket implements IModel {
	...
	public ModelDynCustomBucket(@Nullable final Fluid fluid, final boolean flipGas)
	{
		this(fluid, flipGas, true);
	}

	public ModelDynCustomBucket(@Nullable final Fluid fluid, final boolean flipGas, final boolean tint)
	{
		baseLocation = new ResourceLocation("sfhcore", "items/bucket_empty"); //baseLocation;
		if (fluid == null)
		{
			liquidLocation = null;    //liquidLocation;
			coverLocation = null;   //coverLocation;
		}
		else
		{
			liquidLocation = new ResourceLocation("sfhcore", "items/bucket_fluid");    //liquidLocation;
			coverLocation = new ResourceLocation("sfhcore", "items/bucket_fluid");   //coverLocation;
		}
		this.fluid = fluid;
	 ...
	 */
	@Override
	public ModelDynCustomBucket retexture(final ImmutableMap<String, String> textures)
	{
	...
	public enum LoaderDynCustomBucket implements ICustomModelLoader
	{
		...
		public void register(final TextureMap map)
		{
		...
		@Nullable
		protected static IResource getResource(final ResourceLocation resourceLocation)
		{
			try
			{
	...
	private static final class CustomBucketBaseSprite extends TextureAtlasSprite
	{
		...
		private CustomBucketBaseSprite(final ResourceLocation resourceLocation)
		{
	...
	private static final class CustomBucketCoverSprite extends TextureAtlasSprite
	{
		...
		private CustomBucketCoverSprite(final ResourceLocation resourceLocation)
		{
			super(resourceLocation.toString());
		}
	...
	private static final class BakedDynCustomBucket extends BakedItemModel
	{
		...
		public BakedDynCustomBucket(final ModelDynCustomBucket parent,
				...
				final Map<String, IBakedModel> cache)
		{
